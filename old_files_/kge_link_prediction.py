...
def _fit(n_epochs, model, n_hidden, n_bases, fanout, lr, dropout,
    ...
    print("dglke_train --model_name "+ model+" --dataset IMDB"+str(test_edge_split)+ " "
               ...
               " 1.00E-09 --test --num_thread 1 --gpu " + gpu + " --num_proc 8 K_shot" + str(k_fold))
    sys.stdout.flush()
    if k_fold!=0:
        if model== 'RotatE':
            os.system( "dglke_train --model_name "+ model+" --dataset IMDB"+str(test_edge_split)+ " "
                        " --data_path ../data/"+args.dataset+"/ " +"--data_files train"+ str(k_fold)+".txt valid"+ str(k_fold)+".txt test"+ str(k_fold)+".txt"
                       " --format 'raw_udd_hrt' --batch_size 1000 --neg_sample_size  100 --neg_sample_size_eval 100 --no_eval_filter"
                       " --hidden_dim "+str(n_hidden)+" --gamma 19.9 -adv -de" 
                         " --lr "+str(lr)+" --max_step "+str(n_epochs)+" --no_save_emb --log_interval 100 --batch_size_eval 16  --regularization_coef "
                       " 1.00E-09 --test --num_thread 1 --gpu " + gpu + "  --num_proc "+str(len(gpu.split(" "))))
        else:
            os.system( "dglke_train --model_name "+ model+" --dataset IMDB"+str(test_edge_split)+ " "
                        " --data_path ../data/"+args.dataset+"/ " +"--data_files train"+ str(k_fold)+".txt valid"+ str(k_fold)+".txt test"+ str(k_fold)+".txt"
                       " --format 'raw_udd_hrt' --batch_size 1000 --neg_sample_size  100 --neg_sample_size_eval 100 --no_eval_filter"
        ...
        if model== 'RotatE':
            os.system( "dglke_train --model_name "+ model+" --dataset IMDB"+str(test_edge_split)+ " "
                        " --data_path ../data/"+args.dataset+"/ " +"--data_files train"+ str(test_edge_split)+".txt valid"+ str(test_edge_split)+".txt test"+ str(test_edge_split)+".txt"
                       " --format 'raw_udd_hrt' --batch_size 1000 --neg_sample_size  100 --neg_sample_size_eval 100 --no_eval_filter"
                       " --hidden_dim "+str(n_hidden)+" --gamma 19.9 -adv -de" 
                         " --lr "+str(lr)+" --max_step "+str(n_epochs)+" --no_save_emb --log_interval 100 --batch_size_eval 16  --regularization_coef "
                       " 1.00E-09 --test --num_thread 1 --gpu " + gpu + "  --num_proc "+str(len(gpu.split(" "))))
...
def fit(args):
        ...
        dropout_list = [0.1]
        fanout_list = [None]
        K_list=[0]#[10,50,100,1000]#[2,5,10,15]
